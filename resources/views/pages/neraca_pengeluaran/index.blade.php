...
<div class="container-fluid m-0 p-0">
    <div class="menuPengeluaran row justify-content-center bg-dark">
        <div class="col border border-white rounded t_o_button btn btn-dark" onclick="toggleAnimation({ '.addPengeluaranContainer' : ['selectedSlide', 'slided'],'.chartContainer' : ['slided', 'selectedSlide'], '.addDataPengeluaran' : ['selectedSlide', 'slided'], '.dataPengeluaranTabel' : ['selectedSlide', 'slided'], '.editPengeluaranContainer':['selectedSlide', 'slided']})">
            Tampilkan Chart
        </div>
        <div class="col border border-white rounded t_o_button btn btn-dark" onclick="toggleAnimation({'.chartContainer' : ['selectedSlide', 'slided'], '.addPengeluaranContainer' : ['selectedSlide', 'slided'], '.addDataPengeluaran' : ['slided', 'selectedSlide'], '.dataPengeluaranTabel' : ['slided', 'selectedSlide'], '.editPengeluaranContainer':['selectedSlide', 'slided']})">
            Data Table
        </div>
    </div>
    <div class="wrap" style="position: relative">
        ...
        @if($userRole == 'Admin')
        <div class="row slided justify-content-center bg-dark addDataPengeluaran" style="position: relative;">
            <div class="col border border-white rounded t_o_button btn btn-dark" onclick="toggleAnimation({'.addPengeluaranContainer' : ['slided', 'selectedSlide'], '.dataPengeluaranTabel' : ['selectedSlide', 'slided'], '.editPengeluaranContainer':['selectedSlide', 'slided']})">
                Tambah Data
            </div>
        </div>
        @endif
        <div class="container-fluid slided dataPengeluaranTabel">
            <div class="row">
                <div class="col">
                    <div class="card">
                        <div class="card-header">
                        <h3 class="card-title text-dark">Tabel Data Neraca Pengeluaran</h3>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body" style="position:relative;">
                            <table id="nPTabel" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                        @foreach($neraca->where('kategori_neraca_id', 2) as $data)
                                            <tr>
                                                ...
                                                <td>
                                                    <table class="table table-bordered table-striped ">
                                                        ...
                                                        <tr>
                                                            <td>{{ " [ ".$child->kategori->kategori_kegiatan }}</td>
                                                            <td>{{ " ".date_format(date_create($child->start),"l, d-F-Y") ." "}}</td>
                                                            <td>{{ " ".date_format(date_create($child->end),"l, d-F-Y") ." ] " }}</td>
                                                        </tr> 
                                                        @endforeach
                                                        </tbody>
                                                        <tfoot>
        ...
        <div class="container-fluid slided addPengeluaranContainer">
            <!-- Content Header (Page header) -->
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                        <h1 class="m-0">Tambah Data Neraca Pengeluaran</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="home">Home</a></li>
                            <li class="breadcrumb-item active">Neraca Pengeluaran</li>
                        </ol>
                        </div><!-- /.col -->
                    </div><!-- /.row -->
                </div><!-- /.container-fluid -->
            ...
            <div class="container-fluid">
                <div class="g-0 addFormContainer">
                    <form action="addPengeluaran" method="POST">
                        @csrf
                        <input type="hidden" name="nL" value="Pengeluaran">
                        <div class="row">
                        <div class="col-8">
        ...
        @if (session('idData'))
        <div class="container-fluid selectedSlide editPengeluaranContainer">
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                        <h1 class="m-0">Edit Data Neraca Pengeluaran</h1>
                        </div>
                        <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="home">Home</a></li>
